...
print("LangCell Transcriptome Tokenization Pipeline - Ovarian Cancer")
print("=============================================================")
...
dataset_name = f"tokenized_dataset_ovarian_{timestamp}"
...
# 10) Create cell type descriptions for ovarian data
...
print("\n" + "="*60)
print("OVARIAN CANCER PREPROCESSING COMPLETE!")
print("="*60)
