...
print("LangCell Transcriptome Tokenization Pipeline - Prostate Cancer")
print("=============================================================")
...
for col in adata.obs.columns:
    if col in ['sample', 'cell_type', 'source', 'disease', 'group']:
        obs2col[col] = col
...
if unassigned_mask.sum() > 0:
    ...
    if 'mp_assignment' in adata.obs.columns:
        ...
        # Map MP assignments to cell types
        mp_to_celltype = {
...
dataset_name = f"tokenized_dataset_prostate_{timestamp}"
...
# 10) Create cell type descriptions for prostate data
...
print("\n" + "="*60)
print("PROSTATE CANCER PREPROCESSING COMPLETE!")
print("="*60)
